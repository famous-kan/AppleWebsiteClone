  ...
  const onoff = () => {
    ...
    return (
      ...
      <div>
              ...
              <div className="container flex gap-5 pt-1 m-0 px-0 min-w-full" style={{animationPlayState: isRunning ? "running" : "paused"}}>
                {images.map((item) => (
                  <div className="image-item" key={item.id}>
                    <div className="image-container ">
                      <img src={item.image} alt={item.detail} className="image" />
                      <div className="overlay">
                        <Button variant="light" className="action-button rounded-pill">{item.onbut}</Button>
                      </div>
                      <div className="icon">
                        {item.icon}
                      </div>
                ...
                {images.map((item) => (
                  <div className="image-item " key={item.id + "-clone"}>
                    <div className="image-container">
                      <img src={item.image} alt={item.detail} className="image" />
                      <div className="overlay">
                        <Button variant="light" className="action-button rounded-pill">{item.onbut}</Button>
